...
const generateEmail = async (first_name, surname, id_country) => {
    ...
    var countemail = 0
    var init_email = `${first_name.split(" ").join("").toLowerCase()}.${surname.split(" ").join("").toLowerCase()}`
    var exists_email = ''
    ...
    do{
        ...
        if(exists_email) {
            countemail++
            init_email = `${first_name.split(" ").join("").toLowerCase()}.${surname.split(" ").join("").toLowerCase()}.${countemail}`
        }
